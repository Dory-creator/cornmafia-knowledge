Stake-and-Earn - Token Staking | RISEWiki
...
Players can earn rewards for staking [$COPI](/blockchain/usdcopi-token). Using Decentralized Finance (DeFi) players can purchase tokens, then lock them in a staking pool for a set amount of days. In return players will have access to various rewards depending on how much they stake and for how long.

These rewards include:

* COPI will be rewarded for yield farming and traditional staking.
* NFT rewards which can be kept in wallets, traded with other players, or sold for real-world value.
* Access to exclusive in-game areas.

[PreviousStake-and-Earn](/gameplay/about-the-game/stake-and-earn)[NextStake-and-Earn - Properties](/gameplay/about-the-game/stake-and-earn/stake-and-earn-properties)
