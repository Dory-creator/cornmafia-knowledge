...
The [Launcher](/gameplay/game-launcher) has a number of add-on features that enable it to host a secure, encrypted, decentralized version of the Cornucopias database and also player and game files.
