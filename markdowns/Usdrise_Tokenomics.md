...
* 🎮GAMEPLAY
  ...
  + [About the game](/gameplay/about-the-game)
    ...
    - [$RISE Tokenomics](/gameplay/about-the-game/usdrise-tokenomics)
      ...
      * [Token Economy](/gameplay/about-the-game/usdrise-tokenomics/token-economy)
      * [Token Metrics](/gameplay/about-the-game/usdrise-tokenomics/token-metrics)
      * [Business Model](/gameplay/about-the-game/usdrise-tokenomics/business-model)
...
* [Gaming Overview](#gaming-overview)
...
Infinity Rising aims to address these issues by introducing a **massive gaming world with an expanding network of floating domes**, each offering unique themes and gameplay experiences. Players can own characters, land, and other NFT-based assets with real-world value within this immersive and expanding game environment. Through blockchain technology, Infinity Rising empowers players to earn rewards through gameplay, building activities, and educational experiences. Players can immerse themselves in the robust game economy, where they can accumulate real-world value while exploring and constructing within a secure virtual world. Infinity Rising is designed to evolve continuously with the introduction of new features and functionalities accessible across various platforms.

> Every player plays a crucial role in shaping the world of Infinity Rising, contributing to the construction of the entire in-game ecosystem, economy, and community.
...
The COPI token is the utility token of the Infinity Rising ecosystem, offering a wide range of features. It plays a crucial role in Infinity Rising by facilitating various essential functions. All game related transactions on the platform necessitate the use of the RISE token. Moreover, rewards for activities like staking, providing liquidity, gameplay , and operating nodes are distributed in RISE tokens. Staking the token also provides discounts, incentivizing adoption and engagement in governance. These attributes and utilities may be influenced over time by RISE token holders through governance mechanisms.

Let's dig into the Token Economy…

[PreviousHost-and-Earn](/gameplay/about-the-game/host-and-earn)[NextToken Economy](/gameplay/about-the-game/usdrise-tokenomics/token-economy)
