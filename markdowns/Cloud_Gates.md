...
To explore the [Themed Zones](/gameplay/themed-zones) and the City, players need to fly through one of the cloud gates. The cloud gates provide safe and speedy passage into the deeper realms of the Infinity Rising Multiverse where the larger domes can be found.

The cloud gates will have floating signs, pointing you in the right directions for your chosen destinations.

The first [Unreal Engine](/the-company/technology/unreal-engine-5-ue5) 5 image we have ever shared​ is of a Cloud Gate.
...
Image of the Cloud Gate - the first UE5 image that was shared back in 2022 (this has now been updated in game)
