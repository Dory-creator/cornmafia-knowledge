...
[Powered by GitBook](https://www.gitbook.com/?utm_source=content&utm_medium=trademark&utm_campaign=PQmCVki2WHg9QcW9pdrX)On this page* [Clay Grinder](#clay-grinder)
* [Extruder](#extruder)
* [Kiln](#kiln)
...
The workshop necessary for processing [rock](/gameplay/gameplay-pc/resources/rock) to create building resources. 

Brickworks can be found in every [district](/gameplay/themed-zones/sectors/land-sector-districts) and include a clay grinder and brick oven. 

Clay Grinder
------------

The workstation is used to grind down rocks into shale in preparation for brick creation. 

Extruder
--------

Clay and water is pumped through the machine to form one long continuous piece called a 'slug' on a conveyor belt. The 'slug' is shaped and cut into brick pieces using a guillotine like knife.

Kiln
----

The workstation used to solidify bricks to be used for buildings. 

[PreviousCarpenter](/gameplay/themed-zones/sectors/land-sector-districts/district-workshops/carpenter)[NextKitchen](/gameplay/themed-zones/sectors/land-sector-districts/district-workshops/kitchen)Last updated 3 years ago
