Property Rentals - Farmhouse | RISEWiki
...
* [Tenancy Benefits](#tenancy-benefits)
...
Farmhouses come in 5 different types and sizes as follows and can be crafted/placed onto a player-owned land plot:
...
Upgrading a farmhouse provides the land owner with additional rooms to rent (potential revenue) and gives the tenant a temporary place to spawn. It also unlocks additional play options for the tenant as they will be now classed as a district member.
...
* The player can rest in the farm house and gain health and stamina benefits.
* The player can participate in district challenges.
* The player may receive discounts from the land owners shops/utilities.

### **Maintenance**

Farmhouses require maintenance and repairs over time. The rate may be dependent on its size and the number of days the Farmhouse has been active. See [Building Maintenance](/gameplay/themed-zones/sectors/land-sector-districts/district-land-plots/land-plot-utility/buildings-utility-and-vehicles/building-maintenance) for more details.

[PreviousLand Plot - Property Rentals](/gameplay/themed-zones/sectors/land-sector-districts/district-land-plots/land-plot-property-rentals)[NextProperty Rentals - Hotels](/gameplay/themed-zones/sectors/land-sector-districts/district-land-plots/land-plot-property-rentals/property-rentals-hotels)
