...
Today, all active node owners are sharing in the rewards. In future, performance metrics will tie into how rewards are distributed.

See also Reward Distribution

[PreviousManaging Pool Server](/documentation/nodes/guide-how-to-set-up-a-file-node-pool/managing-pool-server)[NextPublic Pools](/documentation/nodes/guide-how-to-set-up-a-file-node-pool/public-pools)
