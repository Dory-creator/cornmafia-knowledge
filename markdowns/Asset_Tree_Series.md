...
* 🌐ON CHAIN
  ...
  + [Player Owned Assets](/on-chain/player-owned-assets)
    ...
    - [Asset - Tree Series](/on-chain/player-owned-assets/asset-tree-series)
      ...
      * [Tree Series 1](/on-chain/player-owned-assets/asset-tree-series/tree-series-1)
      * [Tree Series 2](/on-chain/player-owned-assets/asset-tree-series/tree-series-2)
      * [Tree Series 3](/on-chain/player-owned-assets/asset-tree-series/tree-series-3)
...
​The Tree Series, created in partnership with Veritree (a Cardano project providing Verified Global Restoration Projects and Accelerating the adoption of nature-based climate solutions), is a unique and environmentally conscious way to bridge the gap between the metaverse and real-life.​

The Tree series is used to "stress test" the performance and new features of the Cornucopias minting platform. A major Asset always follows the Tree sales​
...
[PreviousRando's Metalworks Sunset Speeder 2024](/on-chain/player-owned-assets/asset-flying-vehicles/randos-metalworks-vehicles/randos-metalworks-sunset-speeder-2024)[NextTree Series 1](/on-chain/player-owned-assets/asset-tree-series/tree-series-1)
